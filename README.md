...
To run the executable file, you must move the "ospec.txt" file from this repository into the same directory. The "ospec.txt" file is needed for the lexical analyzer to correctly lex the supported UCI commands.
